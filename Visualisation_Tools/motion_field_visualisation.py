...
def view_ang_flow(motion_field, ang_only=False):
    ...
    """
    Create the angular flow from the optical flow field and visualise using HSV colouring.
    
    Inputs:
    -------
    motion_field: n_rows x n_cols x 2 numpy array where the two dimensions are assumed to be (x,y) 
